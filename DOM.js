...
DOM.getIndex=function(ele){
    return this.getPres(ele).length;//获取所有哥哥的长度，那么就是他的索引
    return ele.parentNode.children.length-this.getNexts(ele).length-1;//获取所有兄弟的长度-所有弟弟的长度-1，那么就是他的索引
    var all=ele.parentNode.children;
